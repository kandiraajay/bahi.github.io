      ...
      <div className="experiences">
        ...
        <div className="idustrial-exp">
          <div className="ind-item">
            <h2 className="orgname">Onclick I,T. Solutions</h2>
            ...
            <p>
              ...
              Builsing reusable components and front-end libraries for future
              ...
              of web-capable devices and browser
            </p>
          </div>

          <div className="ind-item">
            <h2 className="orgname">Onclick I.T. Solutions</h2>
            <h3 className="position">Laraval Intern</h3>
            <p>12/2023 - 05/2023</p>
            <p>
              Description - Deveioping new user-facing features using React.js *
              Builsing reusable components and front-end libraries for future
